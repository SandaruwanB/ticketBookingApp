      ...
      <div class="container-xl">
        ...
        <div class="container-md w-50 mt-5">
          <form>
            ...
            <h6 class="mb-0 mt-3"><button class="btn btn-md btn-success" id="addcurrMovie">Add</button><button onclick="goBack()" type="button" class="btn btn-md btn-info" style="margin-left : 20px;" id="registerBtn">Cancel</button></h6>
          </form>
        </div>
      </div>
    </section>    
