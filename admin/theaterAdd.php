...
<html lang="en">
  <head>
    ...
    <title>CINEMA : Add Theater</title>
    ...
    <section id="upcome" class="p_3 bg-light">
      <div class="container-xl">
        <div class="row upcome_1 text-center">
          <div class="col-md-12">
            <h3 class="mb-0">ADD NEW THEATER</h3>
        ...
        <div class="container-md w-50 mt-5">
          <form>
            ...
            <div class="form-group">
              ...
              <textarea rows="4" style="width : 100%; border : 1px solid #ccc; padding : 10px; border-radius : 4px;" id="description"></textarea>
            </div>
